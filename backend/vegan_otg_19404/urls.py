"""vegan_otg_19404 URL Configuration
...
admin.site.site_header = "Vegan OTG"
admin.site.site_title = "Vegan OTG Admin Portal"
admin.site.index_title = "Vegan OTG Admin"

# swagger
api_info = openapi.Info(
    title="Vegan OTG API",
    default_version="v1",
    description="API documentation for Vegan OTG App",
)
